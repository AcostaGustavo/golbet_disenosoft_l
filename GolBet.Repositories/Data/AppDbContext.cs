...
namespace GolBet.Repositories.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Team names must be unique (aqui defino que el nombre no se repita)
            modelBuilder.Entity<Team>()
               .Property(t => t.Name)
               .UseCollation("SQL_Latin1_General_CP1_CI_AI"); //Esta parte indica el sesitive case (Nacional - nacional)
